...
<header>
        ...
        <div class="del-pro">
	        ...
	        <button class="add"><a href="3D_SHOP/home/shopping-list.htm?id=${pr.id }&name=${pr.name }&coler=${pr.coler}&gia=${pr.price }&image=${pr.img1}">Thêm</a></button>
            <div class="tab-size">
                <img src="/3D_SHOP/resources/img/banner/size1.jpg" alt="">
            </div>
            </c:forEach>
        </div>
    </div>
...
<footer>
        <div class="footer-cont">
            <img src="3D_SHOP/resources/img/logo/footer.svg" alt="">
            <ul>
               <!--                  Sản phẩm -->
                <li><a href="">Nam</a></li>
                <li><a href="">Nữ</a></li>
...
<!--                 Hỗ Trợ -->
        ...
        <h1>Copyright © 2021 3DShop. All rights reserved.</h1>
    </footer>
</body>
<script>
// Get the modal
