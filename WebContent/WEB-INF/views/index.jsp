...
<body>
	<header>
		<div class="container">
			<div class="logo">
				<a href=""><img
					src=" ${pageContext.request.contextPath}/resources/img/logo/xop3d.png" alt=""></a>
			</div>
			<div class="contener1">
					<ul class="navbar">
            ...
            <div class="user-content">
                ...
                <div class="content-bottom">
                    <c:choose>
                    	...
                    	<c:otherwise><button > <a href="3D_SHOP/home/login.htm"> Đăng xuất</a> </button></c:otherwise>
                    </c:choose>
                </div>
            </div>
        </div>
	...
	<div class="slider">
        <div class=" owl-carousel owl-theme ">
			<c:forEach var = "ban" items="${banner}">
				...
				<div class="item">
                   <div class="item-con">
                    <img src="3D_SHOP/resources/img/banner/${ban.link}">
                  </div>
            	</div>
				</c:if>
			</c:forEach>
	...
	<div class="new-pro">
        ...
        <div class="container-pro">
        	...
        	<div class="item-pro">
                <div class="sale">
                    <a href="${pageContext.request.contextPath}/detail/${pn.id}.htm"><img src="/3D_SHOP/resources/img/pro/${pn.img1}" alt=""></a>
                    <c:if test="${pn.sale!=0}">
                    	<h1>-${pn.sale}%</h1>
                    </c:if>
                </div>
    ...
    <div class="new-pro">
        ...
        <div class="container-pro">
        	...
        	<div class="item-pro">
                <div class="sale">
                    <a href="3D_SHOP/detail/${pn.id}.htm"><img src="/3D_SHOP/resources/img/pro/${pn.img1}" alt=""></a>
                    <c:if test="${pn.sale!=0}">
                    	<h1>-${pn.sale}%</h1>
                    </c:if>
                </div>
                <a href="3D_SHOP/detail/${pn.id}.htm">${pn.name}</a>
                <h3>${pn.coler}</h3>
                <div style="margin-top: 5px" class="price">
                    <c:if test="${pn.sale==0}">
                    	<h3><fmt:formatNumber pattern="###,### VND" value="${pn.price}" type="currency" /></h3>
	...
	<div class="contents">
	 ...
	 <div class="instagram-img">
        ...
        <div class="ig-content">
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/1.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/2.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/3.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/4.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/5.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/6.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/7.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/8.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/9.jpg" alt="">
            </div>
            <div class="item-ig">
                <img src="3D_SHOP/resources/img/ig/11.jpg" alt="">
            </div>
           </div>
    </div>
    ...
    <footer>
        <div class="footer-cont">
            ...
            <ul>
                Liên hệ
                <li><a href="">Email : duongcongsang2000@gmail.com</a></li>
                <li><a href="">Hotline : 0979336861</a></li>
            </ul>
            <ul>
                Hỗ Trợ
                <li><a href="">FAQs</a></li>
        ...
        <h1>Copyright © 2020 3DShop. All rights reserved.</h1>
    </footer>
</body>
<script>
    // Get the modal
